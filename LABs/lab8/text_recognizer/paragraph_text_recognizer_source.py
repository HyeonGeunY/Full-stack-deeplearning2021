...
from text_recognizer.models import ResnetTransformer_source
...
class ParagraphTextRecognizer_source:
    ...
    def __init__(self):
        ...
        model = ResnetTransformer_source(data_config=data.config(), args=args)
